...
def main(py_file, py_class, grc_name, properties, pd):
    modify_resource(py_file, py_class, grc_name, properties, pd)
...
#       break/crash.
# ##############################################################################
def modify_resource(py_file, py_class, grc_name, properties, ports_data):
    ...
    with open(rs_file, "w") as f:
        ...
        f.write("from %s import %s as top_block\n" % (rm_py, py_class))
        f.write("#{% endblock %}\n\n")
